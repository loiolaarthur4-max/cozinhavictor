...
# FUNÇÃO RECARREGAR ESTOQUE (Força leitura do banco)
...
# CARREGA SEMPRE O ESTOQUE ATUALIZADO AO ABRIR/RECARREGAR
...
with col1:
    ...
    local_f = st.selectbox("Local:", ["Geladeira da Cozinha", "Freezer Branco", "Geladeira Red Bull", "Geladeira Grande"], index=["Geladeira da Cozinha", "Freezer Branco", "Geladeira Red Bull", "Geladeira Grande"].index(val["local"]) if val["local"] in ["Geladeira da Cozinha", "Freezer Branco", "Geladeira Red Bull", "Geladeira Grande"] else 0)
